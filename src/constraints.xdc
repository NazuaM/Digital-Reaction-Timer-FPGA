...
## Buttons
# Using the Red CPU RESET button for reset_n (Active Low)
set_property -dict { PACKAGE_PIN C12   IOSTANDARD LVCMOS33 } [get_ports { reset_n }];

# Using BTNU for start and BTND for react
set_property -dict { PACKAGE_PIN M18   IOSTANDARD LVCMOS33 } [get_ports { start_btn }];
set_property -dict { PACKAGE_PIN P18   IOSTANDARD LVCMOS33 } [get_ports { react_btn }];

## LEDs (Changed target_led to leds to match VHDL)
